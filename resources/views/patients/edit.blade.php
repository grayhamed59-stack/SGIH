<x-app-layout>
    ...
    <div class="flex flex-col md:flex-row md:items-center justify-between mb-8 gap-4">
        <div>
            ...
            <h1 class="text-2xl md:text-3xl font-bold text-gray-900 tracking-tight">Modifier le patient</h1>
            <p class="text-gray-500 mt-1">Mise à jour des informations pour le dossier #PT-{{ str_pad($patient->id, 4, '0', STR_PAD_LEFT) }}.</p>
        </div>
        <div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 bg-gray-50/50 p-6 rounded-2xl border border-gray-100">
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    <input id="first_name" name="first_name" type="text" class="block w-full pl-11 pr-4 py-3 bg-white border border-gray-200 rounded-xl text-gray-900 focus:ring-2 focus:ring-sgih-cyan/50 focus:border-sgih-cyan transition-colors shadow-sm" value="{{ old('first_name', $patient->first_name) }}" required autofocus />
                                </div>
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    <input id="last_name" name="last_name" type="text" class="block w-full pl-11 pr-4 py-3 bg-white border border-gray-200 rounded-xl text-gray-900 focus:ring-2 focus:ring-sgih-cyan/50 focus:border-sgih-cyan transition-colors shadow-sm" value="{{ old('last_name', $patient->last_name) }}" required />
                                </div>
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    <input id="birth_date" name="birth_date" type="date" class="block w-full pl-11 pr-4 py-3 bg-white border border-gray-200 rounded-xl text-gray-900 focus:ring-2 focus:ring-sgih-cyan/50 focus:border-sgih-cyan transition-colors shadow-sm" value="{{ old('birth_date', $patient->birth_date) }}" required />
                                </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 bg-gray-50/50 p-6 rounded-2xl border border-gray-100">
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    <input id="phone" name="phone" type="text" class="block w-full pl-11 pr-4 py-3 bg-white border border-gray-200 rounded-xl text-gray-900 focus:ring-2 focus:ring-sgih-cyan/50 focus:border-sgih-cyan transition-colors shadow-sm font-mono" value="{{ old('phone', $patient->phone) }}" />
                                </div>
                            ...
                            <!-- Statut -->
                            <div>
                                <x-input-label for="status" :value="__('Statut actuel')" class="mb-1.5" />
                                <div class="relative">
                                    <div class="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                                    ...
                                    <select id="status" name="status" class="block w-full pl-11 pr-10 py-3 bg-white border border-gray-200 rounded-xl text-gray-900 font-semibold focus:ring-2 focus:ring-sgih-cyan/50 focus:border-sgih-cyan transition-colors shadow-sm appearance-none">
                                        <option value="En attente" @selected(old('status', $patient->status) == 'En attente')>En attente (Nouvelle admission)</option>
                                        <option value="Actif" @selected(old('status', $patient->status) == 'Actif')>Actif (En traitement)</option>
                                    </select>
                                    <div class="absolute inset-y-0 right-0 pr-4 flex items-center pointer-events-none">
                                        <i data-lucide="chevron-down" class="w-4 h-4 text-gray-400"></i>
                                    </div>
                            ...
                            <div class="md:col-span-2">
                                <x-input-label for="address" :value="__('Adresse')" class="mb-1.5" />
                                <div class="relative">
                                    <div class="absolute top-3 left-0 pl-4 flex items-start pointer-events-none">
                                        <i data-lucide="map" class="w-4 h-4 text-gray-400"></i>
                                    </div>
                                    <textarea id="address" name="address" rows="3" class="block w-full pl-11 pr-4 py-3 bg-white border border-gray-200 rounded-xl text-gray-900 focus:ring-2 focus:ring-sgih-cyan/50 focus:border-sgih-cyan transition-colors shadow-sm">{{ old('address', $patient->address) }}</textarea>
                                </div>
